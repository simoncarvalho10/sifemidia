...
function Contact() { 
    ...
    return(  
            <div className="px-6 flex flex-col gap-3 text-[16px] md:text-[20px]">
                ...
                <select name="" id="tpSite" className="w-full p-2 border bg-white rounded-sm border-gray-300">
                ...
                <div className="flex gap-3">
                    <div className="grow">
                        ...
                        <select name="" id="pDominio" className="w-full p-2 border bg-white rounded-sm border-gray-300">
                    ...
                    <div className="w-[40%]">
                        ...
                        <select name="" id="qtdPage" className="w-full p-2 border bg-white rounded-sm border-gray-300">
                ...
                <textarea id='txtObserv' placeholder='Digite aqui o motivo do contato...' className='p-3 bg-white w-full h-[180px] border rounded-sm border-gray-300 resize-none leading-tight'></textarea>
                <button onClick={btnFormContato} id="enviarContato" className="rounded-xl md:rounded-full h-10 md:w-[20%] bg-sky-700 mt-2 text-white">Enviar</button>
            </div>                             
    );
}
