        ...
        <div className="flex flex-col items-center justify-center mt-[80px]">
            ...
            <ul className="w-full flex flex-col items-center justify-center gap-3">
                <li className="w-full flex flex-col bg-white border-gray-400 hover:bg-gray-200">
                    ...
                    <ul id="submenu1" className="submenu border-gray-300 bg-white px-8 py-3" style={{ display: menus["submenu1"] ? "block" : "none" }}>
                        <li>
                ...
                <li className="w-full flex flex-col bg-white border-gray-400 hover:bg-gray-200">
                    ...
                    <ul id="submenu2" className="w-full submenu border-gray-300 bg-white px-8 py-3" style={{ display: menus["submenu2"] ? "block" : "none" }}>
                    <li>
                ...
                <li className="w-full flex flex-col bg-white border-gray-400 hover:bg-gray-200">
                    ...
                    <ul id="submenu3" className="w-full submenu border-gray-300 bg-white px-8 py-3" style={{ display: menus["submenu3"] ? "block" : "none" }}>
                    <li>
                ...
                <li className="w-full flex flex-col bg-white border-gray-400 hover:bg-gray-200">
                    ...
                    className="flex items-center gap-2 px-2"
                    >
                        {!menus["submenu4"] ? <SlArrowRight size={12} /> : <SlArrowDown size={12} />}
                        <p className="text-left">Quais informações preciso fornecer para iniciar o desenvolvimento do site?</p>
                    </button> 
                    <ul id="submenu4" className="submenu border-gray-300 bg-white px-8 py-3" style={{ display: menus["submenu4"] ? "block" : "none" }}>
                        <li>
				...
				<li className="w-full flex flex-col bg-white border-gray-400 hover:bg-gray-200">
                    ...
                    className="flex items-center gap-2 px-2"
                    >
                        {!menus["submenu5"] ? <SlArrowRight size={12} /> : <SlArrowDown size={12} />}
                        <p className="text-left">O site será otimizado para SEO? </p>
                    </button> 
                    <ul id="submenu5" className="submenu border-gray-300 bg-white px-8 py-3" style={{ display: menus["submenu5"] ? "block" : "none" }}>
                        <li>
                ...
                <li className="w-full flex flex-col bg-white border-gray-400 hover:bg-gray-200">
                    ...
                    className="flex items-center gap-2 px-2"
                    >
                        {!menus["submenu6"] ? <SlArrowRight size={12} /> : <SlArrowDown size={12} />}
                        <p className="text-left">O que está incluso no custo do desenvolvimento do site? </p>
                    </button> 
                    <ul id="submenu6" className="submenu border-gray-300 bg-white px-8 py-3" style={{ display: menus["submenu6"] ? "block" : "none" }}>
                        <li>
                ...
                <li className="w-full flex flex-col bg-white border-gray-400 hover:bg-gray-200">
                    ...
                    className="flex items-center gap-2 px-2"
                    >
                        {!menus["submenu7"] ? <SlArrowRight size={12} /> : <SlArrowDown size={12} />}
                        <p className="text-left">Vocês cuidam do registro de domínio e hospedagem?</p>
                    </button> 
                    <ul id="submenu7" className="submenu border-gray-300 bg-white px-8 py-3" style={{ display: menus["submenu7"] ? "block" : "none" }}>
                        <li>
                ...
                <li className="w-full flex flex-col bg-white border-gray-400 hover:bg-gray-200">
                    ...
                    className="flex items-center gap-2 px-2"
                    >
                        {!menus["submenu8"] ? <SlArrowRight size={12} /> : <SlArrowDown size={12} />}
                        <p className="text-left">Meu site será escalável?</p>
                    </button> 
                    <ul id="submenu8" className="submenu border-gray-300 bg-white px-8 py-3" style={{ display: menus["submenu8"] ? "block" : "none" }}>
                        <li>
